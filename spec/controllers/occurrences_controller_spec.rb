  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved occurrence as @occurrence" do
        ...
        post :create, {:occurrence => { "title" => "invalid value" }}, valid_session
        assigns(:occurrence).should be_a_new(Occurrence)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested occurrence" do
        ...
        Occurrence.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => occurrence.to_param, :occurrence => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the occurrence as @occurrence" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Occurrence.any_instance.stub(:save).and_return(false)
        put :update, {:id => occurrence.to_param, :occurrence => { "title" => "invalid value" }}, valid_session
        assigns(:occurrence).should eq(occurrence)
      end
